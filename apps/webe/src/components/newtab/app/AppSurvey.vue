<template>
  ...
  >
    <button
      class="absolute -right-2 -top-2 scale-0 rounded-full bg-card border border-border shadow-md transition group-hover:scale-100"
      @click="closeModal"
    >
      <v-remixicon class="text-muted-foreground" name="riCloseLine" />
    </button>
