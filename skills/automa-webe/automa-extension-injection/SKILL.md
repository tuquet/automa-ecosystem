...
description: Kiến trúc Vòng đời Chromium Extension & Các nguyên tắc tương tác an toàn qua Puppeteer (automa-ext / automa-ex).
---
...
ExecutionContext của Puppeteer bị hủy diệt nếu trang HTML điều hướng, reload, hoặc đóng.
...
* Nguồn dữ liệu gốc (Source of Truth) là `browser.storage.local`.
