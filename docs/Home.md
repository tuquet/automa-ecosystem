...
- 🚇 [**Cloudflare SSH Tunnel & Git Relay Guide (`CLOUDFLARE_TUNNEL_GIT_RELAY.md`)**](./CLOUDFLARE_TUNNEL_GIT_RELAY.md): Cẩm nang thiết lập hạ tầng mạng ngầm, tự động kết nối Cloudflare SSH Tunnel (`127.0.0.1:2222`) và quy trình Git Relay 1-Click an toàn vượt tường lửa.
