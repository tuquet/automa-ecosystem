...
| ID (File JSON) | Tên Workflow | Mô tả Workflow | Dependency Packages | Link xem chi tiết |
|---|---|---|---|---|
| `wf-login` | `Login` | Đăng nhập vào hệ thống CRM CMC Global | [\[form\] Login](../crm-fe-packages/pkg-form-login.json), [\[check\] Authenticate](../crm-fe-packages/pkg-check-authenticate.json), [\[auth\] Logout](../crm-fe-packages/pkg-auth-logout.json) | [wf-login.json](./wf-login.json) |
